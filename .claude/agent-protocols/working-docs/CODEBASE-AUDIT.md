...
| ~~F7~~ | ~~Batch F~~ | ~~DEFERRED Part 11 P10 — EYE/MITHRIL FlakyTest root cause audit~~ | ✅ DONE 2026-06-23 — `ab98f1370` — 11 de-tagged (fix), 2 deleted; SyncController FastSync.Done guard added; coverage gap logged CHASE-QUEUE |
