...
| E5e | Batch F | DEFERRED §8a-infra-c — MITHRIL: replace classic `actorSelection` worker-ref pattern with Typed injection in ByteCodeCoordinatorSpec + AccountRangeCoordinatorSpec | No — cosmetic; after E5d |
...
- ~~**Batch F (remaining)**~~: ~~E5d ∥ E5e ∥ §P9-FRESHPIVOT~~ — §P9-FRESHPIVOT ✅ `083f08836`; E5d/E5e still open
