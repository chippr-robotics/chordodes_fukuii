  ...
  object Blocks {
    ...
    object Genesis extends FixtureBlock {
      val header: BlockHeader = BlockHeader(
        ...
        stateRoot = TrieRoot(ByteString(Hex.decode("d7f8974fb5ac78d9ac099b9ad5018bedc2ce0a72dad1827a1709da30580f0544"))),
    ...
    object DaoForkBlock extends FixtureBlock {
      override val header: BlockHeader = BlockHeader(
        ...
        stateRoot = TrieRoot(ByteString(Hex.decode("614d7d358b03cbdaf0343529673be20ad45809d02487f023e047efdce9da8aff"))),
        transactionsRoot = TrieRoot(ByteString(Hex.decode("d33068a7f21bff5018a00ca08a3566a06be4196dfe9e39f96e431565a619d455"))),
        receiptsRoot = TrieRoot(ByteString(Hex.decode("7bda9aa65977800376129148cbfe89d35a016dd51c95d6e6dc1e76307d315468"))),
        logsBloom = BloomFilter(ByteString(Hex.decode("0" * 512))),
    ...
    object ProDaoForkBlock extends FixtureBlock {
      override val header: BlockHeader = BlockHeader(
        ...
        stateRoot = TrieRoot(ByteString(Hex.decode("c5e389416116e3696cce82ec4533cce33efccb24ce245ae9546a4b8f0d5e9a75"))),
        transactionsRoot = TrieRoot(ByteString(Hex.decode("7701df8e07169452554d14aadd7bfa256d4a1d0355c1d174ab373e3e2d0a3743"))),
        receiptsRoot = TrieRoot(ByteString(Hex.decode("26cf9d9422e9dd95aedc7914db690b92bab6902f5221d62694a2fa5d065f534b"))),
        logsBloom = BloomFilter(ByteString(Hex.decode("0" * 512))),
        difficulty = BigInt("62413376722602"),
        number = 1920000,
        gasLimit = 4712384,
    ...
    object DaoParentBlock extends FixtureBlock {
      override val header: BlockHeader = BlockHeader(
        ...
        stateRoot = TrieRoot(ByteString(Hex.decode("fdf2fc04580b95ca15defc639080b902e93892dcce288be0c1f7a7bbc778248b"))),
        transactionsRoot = TrieRoot(ByteString(Hex.decode("56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421"))),
        receiptsRoot = TrieRoot(ByteString(Hex.decode("56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421"))),
