  ...
  "BlockRewardCalculator" should "correctly calculate block and ommer rewards" taggedAs (UnitTest, StateTest) in {
    ...
    val table = Table[MonetaryPolicyConfig, BigInt, List[BigInt], BigInt, List[BigInt], BigInt, BigInt](
      ...
      (
        ...
        1000000,
        List(999999),
        5156250000000000000L,
        List(4375000000000000000L),
        standardByzantiumBN,
        standardConstantinopleBN
      ),
      (
        standardMP,
        5000000,
        List(4999998, 4999997),
        5312500000000000000L,
        List(3750000000000000000L, 3125000000000000000L),
        standardByzantiumBN,
        standardConstantinopleBN
      ),
      ...
      (
        ...
        7000000,
        List(6999999),
        4125000000000000000L,
        List(125000000000000000L),
        standardByzantiumBN,
        standardConstantinopleBN
      ),
      (
        standardMP,
        10000000,
        List(9999998, 9999997),
        4250000000000000000L,
        List(125000000000000000L, 125000000000000000L),
        standardByzantiumBN,
        standardConstantinopleBN
      ),
      (
        standardMP,
        20000000,
        List(19999998, 19999997),
        2720000000000000000L,
        List(80000000000000000L, 80000000000000000L),
        standardByzantiumBN,
        standardConstantinopleBN
      ),
      (
        ...
        20000001,
        List(19999998, 19999997),
        2176000000000000000L,
        List(64000000000000000L, 64000000000000000L),
        standardByzantiumBN,
        standardConstantinopleBN
      ),
      ...
      (
        ...
        78,
        List(77, 77),
        BigInt("20070057552195990"),
        List(BigInt("590295810358705"), BigInt("590295810358705")),
        lowByzantiumBN,
        testConstantinopleBN
      )
    )
