...
object EthMiningJsonMethodsImplicits extends JsonMethodsImplicits {
  ...
  implicit val eth_setEtherbase: JsonMethodDecoder[EthMiningService.SetEtherbaseRequest]
    with JsonEncoder[EthMiningService.SetEtherbaseResponse] =
    new JsonMethodDecoder[EthMiningService.SetEtherbaseRequest]
      with JsonEncoder[EthMiningService.SetEtherbaseResponse] {
