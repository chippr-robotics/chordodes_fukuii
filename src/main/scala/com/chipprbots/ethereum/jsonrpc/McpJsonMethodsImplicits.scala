...
object McpJsonMethodsImplicits extends JsonMethodsImplicits {
  ...
  implicit val mcpResourcesCapabilityEncoder: JsonEncoder[McpResourcesCapability] =
  ...
  implicit val mcpInitializeResponseEncoder: JsonEncoder[McpInitializeResponse] =
  ...
  implicit val mcpResourcesListResponseEncoder: JsonEncoder[McpResourcesListResponse] =
  ...
  implicit val mcpResourcesReadResponseEncoder: JsonEncoder[McpResourcesReadResponse] =
  ...
  implicit val mcpPromptsListResponseEncoder: JsonEncoder[McpPromptsListResponse] =
  ...
  implicit val mcpPromptsGetResponseEncoder: JsonEncoder[McpPromptsGetResponse] =
